  ...
  <section id="how-it-works" className="w-full py-24 bg-gradient-to-br from-[#f8fdf8] to-white border-t border-gray-100">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-20">
            <Link href="/marketplace" className="bg-[#43CD66] hover:bg-[#3ab558] text-[#102D21] font-medium py-4 px-10 rounded-full inline-flex items-center transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
