...
export const metadata: Metadata = {
  ...
  description:
    "Learn how Commerce Central collects, uses, and safeguards your data across our B2B liquidation platform. Read our full Privacy Policy for details.",
  alternates: {
    ...
    <main className="container mx-auto mt-6 px-4 py-8">
      <article className="prose lg:prose-xl mx-auto max-w-4xl">
        <h1 className="mb-6 text-center text-3xl font-bold">
          Commerce Central Privacy Policy
        </h1>
        ...
        <div className="mb-4">
          ...
          <p className="mb-4">
            At Commerce Central, we take your privacy seriously. Please read
            this Privacy Policy to learn how we treat your personal data. By
            using or accessing our Services in any manner, you acknowledge that
          ...
          <p className="mb-4">
            Remember that your use of Commerce Central&apos;s Services is at all
          ...
          <p className="mb-4">
            ...
            change this Privacy Policy from time to time. Upon such changes, we
            will alert you to any such changes by placing a notice on the
            Commerce Central website, by sending you an email and/or by some
        ...
        <section className="mt-8">
          ...
          <p className="mb-4">
            ...
            when you access or use our Services. &quot;Personal Data&quot; means
        ...
        <section className="mt-8">
          <h2 className="mb-4 text-2xl font-bold">Personal Data</h2>
              ...
              <div className="hidden md:block">
                <table className="w-full border-collapse">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="bg-gray-100 px-4 py-3 text-left text-sm font-semibold text-gray-700">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    <tr className="transition-colors hover:bg-gray-50">
                      ...
                      <td className="px-4 py-4 text-sm">
                        First and last name, Email, Phone number, Mailing
                    ...
                    <tr className="transition-colors hover:bg-gray-50">
                      <td className="px-4 py-4 text-sm">Payment Data</td>
                      <td className="px-4 py-4 text-sm">
                        Financial account information, Payment card type, Last 4
                        digits of payment card, Billing address, phone number,
                        and email
                      </td>
                      <td className="px-4 py-4 text-sm">
                        Service Providers (specifically our payment processing
                        partner, currently Stripe)
                      </td>
                    </tr>
                    <tr className="transition-colors hover:bg-gray-50">
                      <td className="px-4 py-4 text-sm">Commercial Data</td>
                      <td className="px-4 py-4 text-sm">
                        Purchase history, Consumer profiles
                      </td>
                      <td className="px-4 py-4 text-sm">
                        Service Providers, Advertising Partners, Analytics
                        Partners, Business Partners
                      </td>
                    </tr>
                    <tr className="transition-colors hover:bg-gray-50">
                      <td className="px-4 py-4 text-sm">Device/IP Data</td>
                      <td className="px-4 py-4 text-sm">
                        IP address, Device ID, Domain server, Type of
                        device/operating system/browser used to access the
                        Services
                      </td>
                      <td className="px-4 py-4 text-sm">
                        Service Providers, Advertising Partners, Analytics
                    ...
                    <tr className="transition-colors hover:bg-gray-50">
                      <td className="px-4 py-4 text-sm">Web Analytics</td>
                      <td className="px-4 py-4 text-sm">
                        Web page interactions, Referring webpage/source through
                        which you accessed the Services, Non-identifiable
                        request IDs, Statistics associated with the interaction
                    ...
                    <tr className="transition-colors hover:bg-gray-50">
                      <td className="px-4 py-4 text-sm">Geolocation Data</td>
                      <td className="px-4 py-4 text-sm">
                    ...
                    <tr className="transition-colors hover:bg-gray-50">
                      <td className="px-4 py-4 text-sm">
                        Other Identifying Information that You Voluntarily
                        Choose to Provide
                      </td>
                      <td className="px-4 py-4 text-sm">
                        Identifying information in emails, letters, texts, or
                ...
                {[
                  {
                    ...
                    examples:
                      "First and last name, Email, Phone number, Mailing address, Unique identifiers such as passwords",
                    parties: "Service Providers, Business Partners",
                  },
                  {
                    category: "Payment Data",
                    examples:
                      "Financial account information, Payment card type, Last 4 digits of payment card, Billing address, phone number, and email",
                    parties:
                  ...
                  },
                  {
                    ...
                    parties:
                      "Service Providers, Advertising Partners, Analytics Partners, Business Partners",
                  },
                  {
                  ...
                  >
                    ...
                    <div className="text-sm text-gray-600">
                      <div className="mb-1 font-medium">Shared with:</div>
                      {item.parties}
                    </div>
                  </div>
                ))}
              ...
              <tbody>
                <tr>
                  ...
                  <td className="border border-gray-300 px-4 py-2">
                    When you provide such information directly to us. When you
                    use the Services and such information is collected
                    automatically.
                  </td>
                </tr>
                <tr>
          ...
          <section className="mt-8">
            ...
            <ul className="mb-4 list-inside list-disc">
              <li>
                ...
                information about Commerce Central or the Services.
              </li>
              <li>
            ...
            <ul className="mb-4 list-inside list-disc">
              ...
              <li>
                Protecting the rights, property or safety of you, Commerce
                Central or another party.
              </li>
        ...
        <section className="mt-8">
          ...
          <h3 className="mt-4 mb-2 text-xl font-bold">Service Providers</h3>
          ...
          <ul className="mb-4 list-inside list-disc">
            ...
            <li>
              Our payment processing partner Stripe collects your
          ...
          <h3 className="mt-4 mb-2 text-xl font-bold">Advertising Partners</h3>

          <p className="mb-4">
            These parties help us market our services and provide you with other
          ...
          <h3 className="mt-4 mb-2 text-xl font-bold">Analytics Partners</h3>
          ...
          <h3 className="mt-4 mb-2 text-xl font-bold">Business Partners</h3>
          ...
          <h3 className="mt-4 mb-2 text-xl font-bold">Legal Obligations</h3>
          ...
          <h3 className="mt-4 mb-2 text-xl font-bold">Business Transfers</h3>
        ...
        <section className="mt-8">
          ...
          <h4 className="mt-4 mb-2 text-lg font-bold">Essential Cookies</h4>
          ...
          <h4 className="mt-4 mb-2 text-lg font-bold">Functional Cookies</h4>
          ...
          <h3 className="mt-4 mb-2 text-xl font-bold">Managing Cookies</h3>
          ...
          <p className="mb-4">
            ...
            including when you leave the Services. To accomplish this, we or our
            service providers may deliver Cookies, including a file (known as a
            “web beacon”) from an ad network to you through the Services. Web
        ...
        <section className="mt-8">
          <h2 className="mb-4 text-2xl font-bold">Personal Data of Children</h2>
          ...
          <p className="mb-4">
            ...
            Personal Data to us, please contact us at team@commercecentral.io.
          </p>
        </section>
        ...
        <section className="mt-8">
          ...
          <section className="mt-4">
            ...
            <p className="mb-4">
              ...
              contact us at team@commercecentral.io.
            </p>
          ...
          <section className="mt-8">
            <h3 className="mb-2 text-xl font-bold">Nevada Resident Rights</h3>
            ...
            <p className="mb-4">
              ...
              contacting us at team@commercecentral.io with the subject line
              “Nevada Do Not Sell Request” and providing us with your name and
              the email address associated with your account. Please note that
              we do not currently sell your Personal Data as sales are defined
