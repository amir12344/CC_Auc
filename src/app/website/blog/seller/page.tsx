...
export const metadata: Metadata = {
  ...
  description: 'Industry insights, best practices, and strategic advice for brands and surplus inventory sellers. Learn how to optimize excess inventory management and recovery strategies.',
  alternates: {
  ...
  openGraph: {
    ...
    title: 'Seller Insights | Commerce Central Blog',
    description: 'Industry insights and best practices for brands and surplus inventory sellers. Learn how to optimize excess inventory management and recovery strategies.',
    images: [
      {
