...
export const metadata: Metadata = {
  title: 'Commerce Central - Podcast',
  description: 'Listen to the Commerce Central podcast where we discuss industry trends, insights, and interviews with experts in the commerce space.',
  alternates: {
  ...
  openGraph: {
    ...
    title: 'Commerce Central Podcast',
    description: 'Tune in to our podcast for the latest discussions on commerce trends, surplus inventory management, and interviews with industry leaders.',
    images: [
      {
