    ...
    <div className="flex min-h-screen bg-white">
      ...
      <div className="w-full lg:w-1/2 flex flex-col p-8 md:p-16 justify-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label htmlFor="referralSource" className="block text-sm font-medium mb-2">How did you hear about us?</label>
            <select
              id="referralSource"
              name="referralSource"
      ...
      <div className="hidden lg:block w-1/2 bg-black relative">
        ...
        <div className="absolute bottom-16 left-1/2 transform -translate-x-1/2 w-4/5 bg-black/80 backdrop-blur-xs p-6 rounded-lg shadow-lg">
          <p className="text-white italic mb-4">&quot;Access to Commerce Central&apos;s inventory of sought-after brands has fueled a remarkable surge in my business and increased margins.&quot;</p>
