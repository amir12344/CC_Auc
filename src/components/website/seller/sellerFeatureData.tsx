...
export const sellerFeatures: SellerFeatureItemProps[] = [
  // Feature 1: Act Before Inventory Becomes a Liability
  {
    ...
    description:
      "Detect aging or returned stock early and move it before markdowns, write-offs, or warehouse gridlock erode your margins.",
    imagePath: "/images/inventoryChart.png",
    imageAlt:
      "Control tower dashboard showing $ value and space tied to returned inventory at each location",
    customContent: createInventoryAgeVisualization(),
    imageOverlay: createFloatingCard(
      "Inventory Value at Risk",
      <>
        <div className="text-primary text-2xl font-bold">$1.2M</div>
        <div className="text-text-secondary text-xs">Across 3 warehouses</div>
      </>,
      "bottom-right"
    ),
  },
  ...
  // Feature 2: Protect Brand, Pricing, and Channels
  {
    ...
    description:
      "Set guardrails for who can buy your products, at what price, and where they can sell them. Maintain brand integrity while still moving inventory.",
  ...
  // Feature 3: Run Resale on Autopilot
  {
    ...
    description:
      "Set your terms once, then let our platform handle everything from buyer verification to payment processing, shipping coordination, and documentation.",
  ...
  // Feature 4: Always Audit-Ready
  {
    ...
    description:
      "Every transaction is documented with verified buyer information, explicit resale terms, and proof of fulfillment. No more scrambling when auditors come knocking.",
  ...
  // Feature 5: Monetize Across Channels Without Conflict
  {
    ...
    description:
      "Segment your inventory by channel, price point, or geography. Sell the same products through different channels without creating channel conflict.",
    imagePath: "/images/channelManagement.png",
    imageAlt:
      "Channel management dashboard showing distribution across different sales channels",
