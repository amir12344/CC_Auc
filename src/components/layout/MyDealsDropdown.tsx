        ...
        <div className="space-y-1">
          {myDealsItems.map((item) => {
            ...
            return (
              <DropdownMenuItem
                key={item.href}
                className={`cursor-pointer p-3 rounded-lg transition-all duration-200 focus:bg-primary/5 ${active
              ...
              >
                <div className="flex items-center w-full">
                  <div className={`p-2 rounded-md mr-3 ${active
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      <span className={`text-sm font-medium ${active ? 'text-primary' : 'text-gray-900'
                        }`}>
                        {item.title}
                      </span>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <ArrowUpRight className={`h-3 w-3 ${active ? 'text-primary' : 'text-gray-400'
                          }`} />
                      </div>
                    </div>
