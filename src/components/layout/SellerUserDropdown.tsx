...
/**
 * Seller User dropdown menu component that appears when clicking on user avatar
 * Provides access to seller-specific profile, settings, and account management
 */
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-64" align="end" forceMount>
        ...
        <DropdownMenuGroup className="p-1">
          ...
          <DropdownMenuItem
            className="cursor-pointer p-3 hover:bg-gray-50 transition-colors focus:bg-gray-50"
            onClick={() => handleNavigation('/seller/account')}
          >
