...
import { getCollections, getCollectionBySlug, getProductsByCollection } from '../services/collectionsService'
import type { CollectionFilters, Collection } from '../types/collections'
...
export const useCollectionProducts = (slug: string, filters?: CollectionFilters) => {
  return useQuery({
