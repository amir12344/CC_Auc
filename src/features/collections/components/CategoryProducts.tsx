 ...
 */
export const CategoryProducts = ({ category, filters }: CategoryProductsProps) => {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 px-4">
        ...
        <p className="text-muted-foreground text-center mb-4 max-w-md">
          We're having trouble loading products for this collection. 
  ...
  if (!products || products.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 px-4">
        ...
        <p className="text-muted-foreground text-center mb-4 max-w-md">
          Try adjusting your filters or browse other categories to find what you're looking for.
        </p>
        <Button 
          variant="outline" 
