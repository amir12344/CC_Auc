...
export type RequiredFields = 
  | keyof Pick<BasicDetails, 
      'brand' | 'name' | 'category' | 'title' | 'upc' | 'itemNumber' | 
      'images' | 'exRetailPrice' | 'quantity' | 'unitWeight' | 
      'unitDimensions' | 'packaging' | 'condition' | 'containsHazardousMaterials'>
  | keyof Pick<ShippingDetails, 
      'shippingType' | 'shipFrom' | 'freightType' | 'pieceCount' | 
      'estimatedWeight' | 'containsHazardousMaterials'>;
