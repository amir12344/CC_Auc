 ...
 */
export function CoreDetailsSection({ register, setValue, errors, getErrorMessage }: CoreDetailsSectionProps) {
  return (
    <Card className="shadow-lg border-0 bg-white/90 backdrop-blur-sm">
      <CardHeader className="pb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <CardTitle className="text-xl text-gray-900">Core Lot Details</CardTitle>
            <CardDescription>
              Essential product information and specifications for your auction listing
            </CardDescription>
          </div>
      ...
      <CardContent className="space-y-8">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2 mb-4">
            <h3 className="font-semibold text-gray-900">Basic Product Information</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            {/* Brand* */}
            <FormField label="Brand" required error={getErrorMessage(errors.brand)}>
              <Input 
                {...register('brand')} 
            ...
            <FormField label="Name" required error={getErrorMessage(errors.name)}>
              <Input 
                {...register('name')} 
            ...
            {/* Category* */}
            <FormField label="Category" required error={getErrorMessage(errors.category)}>
            ...
            {/* Subcategory* */}
            <FormField label="Subcategory" required error={getErrorMessage(errors.subcategory)}>
            ...
            <FormField label="Title" required error={getErrorMessage(errors.title)}>
              <Input 
                {...register('title')} 
          ...
          <FormField label="Item Description" error={getErrorMessage(errors.itemDescription)}>
            <Textarea 
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            {/* SKU Code / Item #* */}
            <FormField label="SKU Code / Item #" required error={getErrorMessage(errors.skuCodeItemNumber)}>
              <Input 
            ...
            <FormField label="Parent Item #" error={getErrorMessage(errors.parentItemNumber)}>
              <Input 
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            {/* Variant: Yes / No */}
            <FormField label="Variant" required error={getErrorMessage(errors.variant)}>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            <FormField label="Unit Ex-Retail Price" required error={getErrorMessage(errors.unitExRetailPrice)}>
            ...
            {/* Unit Quantity* */}
            <FormField label="Unit Quantity" required error={getErrorMessage(errors.unitQuantity)}>
              <Input 
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            {/* Unit Weight (lbs)* */}
            <FormField label="Unit Weight (lbs)" required error={getErrorMessage(errors.unitWeight)}>
              <Input 
            ...
            <FormField label="Length (in)" required error={getErrorMessage(errors.unitDimensionsLength)}>
              <Input 
            ...
            <FormField label="Width (in)" required error={getErrorMessage(errors.unitDimensionsWidth)}>
              <Input 
            ...
            <FormField label="Height (in)" required error={getErrorMessage(errors.unitDimensionsHeight)}>
              <Input 
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2 mb-4">
            <h3 className="font-semibold text-gray-900">Condition Information</h3>
            <Separator className="flex-1" />
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            
            {/* Condition* */}
            <FormField label="Condition" required error={getErrorMessage(errors.condition)}>
            ...
            {/* Cosmetic Condition */}
            <FormField label="Cosmetic Condition" error={getErrorMessage(errors.cosmeticCondition)}>
              <Select onValueChange={(value) => setValue('cosmeticCondition', value)}>
                <SelectTrigger className="w-full !h-12">
          ...
          <FormField label="Accessories" error={getErrorMessage(errors.accessories)}>
            <Textarea 
