...
const auctionListingSchema = z.object({
  ...
  containsHazardousMaterials: z.string().min(1, 'Contains Hazardous Materials selection is required'),
...
export function AuctionListingForm() {
  ...
  const { saveToStorage, loadFromStorage, clearStorage, getLastSaved } = useFormPersistence({
  ...
  React.useEffect(() => {
    const interval = setInterval(() => {
      ...
      if (currentData.brand || currentData.name || currentData.title || currentData.warehouseAddress1) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="max-w-8xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Create Auction Listing</h1>
            <p className="text-gray-600 mt-1">
              Fill out the details below to create your auction listing. Fields marked with * are required.
            </p>
          </div>
