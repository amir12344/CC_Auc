...
const sectionClasses =
  "relative min-h-[600px] md:min-h-[700px] h-screen flex flex-col justify-between overflow-hidden bg-[#102D21] transition-all duration-700";

const heroImageClasses = "opacity-35 scale-[1.02] brightness-[0.9]";

const containerClasses =
  "container mx-auto px-5 sm:px-6 lg:px-10 relative z-10 flex flex-col justify-between h-full pt-8 md:pt-10 pb-0 max-w-(--breakpoint-xl)";

const contentWrapperClasses =
  "grow flex items-center justify-center pt-0 md:pt-0 pb-6 md:pb-8";

const contentClasses =
  "mx-auto w-full lg:w-11/12 xl:w-9/12 pt-6 md:pt-8 lg:pt-10 xl:pt-12 text-center";

const headingClasses =
  "text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight md:mb-6 lg:mb-8 text-[#43CD66] tracking-tight max-w-5xl mx-auto drop-shadow-sm";

const descriptionClasses =
  "text-[clamp(1rem,2vw,1.5rem)] md:text-[clamp(1.25rem,2.5vw,2rem)] mb-6 md:mb-8 lg:mb-10 mx-auto space-y-3 sm:space-y-4 lg:space-y-4 max-w-3xl leading-relaxed";

const textClasses =
  "text-white flex items-center justify-center gap-1.5 drop-shadow-sm";

const buttonContainerClasses =
  "flex flex-col sm:flex-row gap-5 mb-8 lg:mb-10 xl:mb-12 justify-center max-w-3xl mx-auto";
 ...
 * Optimized for SEO and performance with static content rendering
 */
const HeroSection = () => {
  return (
      ...
      <div className={containerClasses}>
        <div className={contentWrapperClasses}>
          <div className={contentClasses}>
            ...
            >
              The Go-To Platform to Move and Source{" "}
              <span className="text-[#D8F4CC] italic">Surplus Inventory</span>
            </h1>
            ...
            >
              ...
              <p className={`font-normal ${textClasses}`}>
                <span className="relative font-semibold text-[#43CD66]">
                  Commerce Central
                  <span className="absolute -bottom-1 left-0 h-1 w-full rounded-full bg-[#25D366] opacity-70"></span>
                </span>
                makes it all happen.
              </p>
            </div>
            ...
            >
              ...
              >
                <span className="relative z-10 flex items-center">
                  <span>Join Commerce Central</span>
                </span>
              </Link>
            </div>
          </div>
