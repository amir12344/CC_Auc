    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <Image 
          ...
          unoptimized
          quality={100}
          className="opacity-35 scale-[1.02] brightness-[0.9]"
        />
      ...
      <div className='container mx-auto px-5 sm:px-6 lg:px-10 relative z-10 flex flex-col justify-between h-full pt-8 md:pt-10 pb-0 max-w-(--breakpoint-xl)'>
        <div className='grow flex items-center justify-center pt-0 md:pt-0 pb-6 md:pb-8'>
          ...
          <h1
            className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight md:mb-6 lg:mb-8 text-[#43CD66] tracking-tight max-w-5xl mx-auto drop-shadow-sm"
          ...
          >
            ...
            >
              <p className="text-white flex items-center justify-center gap-1.5 drop-shadow-sm">
                Smart brands stay in control and recover more.
              </p>
              <p className="text-white flex items-center justify-center gap-1.5 drop-shadow-sm">
                Smart buyers source better and skip the chaos.
              </p>
              <p className="font-normal text-white flex items-center justify-center gap-1.5 drop-shadow-sm">
