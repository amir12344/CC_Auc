...
const TeamSection: React.FC = () => {
  ...
  return (
    <section
      className='relative min-h-[100dvh] overflow-hidden py-24 transition-theme duration-400 md:py-36'
      id="team"
    >
      ...
      <div
        aria-hidden="true"
        className='pointer-events-none absolute inset-0 transition-theme duration-400'
        style={{
          background: `
      ...
      <div
        aria-hidden="true"
        className='-translate-x-1/3 -translate-y-1/3 absolute top-0 left-0 h-64 w-64 rounded-full bg-[#43CD66] opacity-5'
      />
      <div
        aria-hidden="true"
      ...
      <div className='relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mb-24 text-center'>
          <div className='mt-2 mb-4 inline-flex items-center justify-center'>
            ...
            <span className='mx-3 inline-block font-semibold text-[#43CD66] text-lg tracking-wide'>
              OUR TEAM
            </span>
            <div className="h-[1px] w-8 bg-gradient-to-l from-transparent to-[#43CD66]/70" />
          </div>
          <h2 className='mx-auto mb-8 max-w-4xl font-[600] text-3xl text-[#1C1E21] leading-tight transition-theme duration-400 md:text-5xl'>
        ...
        >
          {teamMembers.map((member) => (
            <div
              className='group hover:-translate-y-1 w-full max-w-xs transition-transform duration-300 sm:w-80'
              key={member.name}
            >
              ...
              <div className="p-4 transition-theme duration-400">
                <h3 className='mb-1 font-[500] text-[#43CD66] text-xl transition-theme duration-400 group-hover:text-primary'>
                  {member.name}
                </h3>
                <p className='text-[#1C1E21] text-md transition-theme duration-400'>
                  {member.title}
                </p>
              </div>
            </div>
