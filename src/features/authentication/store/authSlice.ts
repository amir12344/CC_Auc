        ...
        const amplifyUser: AmplifyUser = {
          ...
          attributes: {
            ...
            'custom:termsAccepted':
              attributes['custom:termsAccepted'] || 'false',
            ...
            'custom:certStatus': attributes['custom:certStatus'] as
              | 'pending'
              | 'approved'
              | 'rejected',
          },
...
const transformAmplifyUserToProfile = (
  ...
  return {
    ...
    certificateStatus: attributes['custom:certStatus'] as
      | 'pending'
      | 'approved'
      | 'rejected'
      | undefined,
    certificateUploadDate: attributes['custom:certUploadDate']
      ? new Date(attributes['custom:certUploadDate'])
      : undefined,
